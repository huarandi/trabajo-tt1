 ...
 * en concreto la pieza movil que cambia de posicion a lo largo de la simulacion
...
public class MobileCell extends Cell
{
    ...
    /**
     * Método que genera los cambios que quiere realizar la celula movil en el siguiente instante
